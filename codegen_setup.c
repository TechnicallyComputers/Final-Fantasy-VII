...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Final Fantasy 7",
    .project_root_env = "FINAL_FANTASY_7_PROJECT_ROOT",
    .build_dir_env = "FINAL_FANTASY_7_BUILD_DIR",
    .force_setup_env = "FINAL_FANTASY_7_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCUS_941.63_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Final_Fantasy_7",
    .prepare_note =
